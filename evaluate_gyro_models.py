        ...
        if os.path.isdir(model_path):
            ...
            if os.path.isdir(processed_data_path):
                for item_name in os.listdir(processed_data_path):
                    # Змінено: тепер item_path - це повний шлях до папки з моделлю та параметрами
...
experimental_file_paths = [
    ...
    os.path.join(experimental_data_folder, "1.xlsx"),  # Доданий файл зі скріншоту
    os.path.join(experimental_data_folder, "2.xlsx")  # Доданий файл зі скріншоту
]
...
if __name__ == '__main__':
    ...
    for model_name, ModelClass in models.items():
        ...
        for folder in stage_sensor_folders:
            ...
            # Замість цього, ми будемо використовувати дані з папки experimental_data
            ...
            for file_path in tqdm(experimental_file_paths,
                ...
                rate = 1 / 108  # Частота дискретизації
                data_type = "freq"
                taus = 'all'
                ...
                try:
                    ...
                    try:
                        ...
                        print(
                            f"Помилка при розрахунку Bias Instability для {file_key}, {sensor_type}, {stage_name}. Allan Deviation містить пусті значення.")
                        bi = None
